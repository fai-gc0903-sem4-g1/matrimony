...
public class UserController {
    ...
    public String doLogin(HttpServletResponse response, HttpServletRequest request, @Valid @ModelAttribute("userLogin") User userLogin, BindingResult bindingResult, String keepLoggin) {
