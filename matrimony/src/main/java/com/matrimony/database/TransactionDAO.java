...
public class TransactionDAO {
	public static void add(Transaction transaction) throws EntityIDHaveAlready{
		if(null==findById(transaction.getId()))
			throw new STException.EntityIDHaveAlready("EntityIDHaveAlready");
