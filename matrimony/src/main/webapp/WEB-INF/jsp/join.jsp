...
<body>
	...
	<div class="container-fluid col-lg-12" style="color: #ddccee">
		<div class="row">
			<form:form modelAttribute="userLogin" id="loginForm"
				action="/matrimony/login" method="POST" class="form-horizontal col-md-4">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-8">
						<input class="form-control" type="text"
							...
							name="username" placeholder="Email hoặc số điện thoại"></input>
				...
				<div class="form-group">
					<div class="col-sm-offset-2">
						<div class="checkbox">
							<label><input type="checkbox" name="keepLoggin" /> Duy
								trì đăng nhập</label> <a class="col-sm-offset-1" style="color: #ffffff"
								href="recover">Lấy lại mật khẩu</a>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-5">
						<input type="hidden" value="login" name="process" /> <input
							class="btn btn-primary" type="submit" value="Đăng nhập" />
					</div>
				</div>
			</form:form>
			...
			<form:form modelAttribute="userReg" id="registerForm"
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input id="middleName" class="form-control" type="text"
							name="middleName" placeholder="Đệm"></input>
					</div>
					<div class="col-sm-3">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 has-feedback has-feedback-left">
						<img style="display: none; padding: 6px 6px;"
							class="form-control-feedback" src="resources/img/loading.gif"
							id="emailChecking"></img> <i id="emailOk"
							style="display: none; color: green;"
							class="form-control-feedback glyphicon glyphicon-ok"></i> <i
							id="emailAlready" style="display: none; color: red;"
							class="form-control-feedback glyphicon glyphicon-exclamation-sign"></i>
						<input id="email" onkeyup="" class="form-control" type="email"
							name="email" value="${userReg.email}" placeholder="Địa chỉ email"></input>
						<div>
				...
				<div class="form-group">
					<label style="color: red;" class="control-label col-sm-1"></label>
					<div class="col-sm-4">
						<input class="btn btn-success" style="width: 200px;" type="submit"
							value="Đăng ký" />
					</div>
				</div>
