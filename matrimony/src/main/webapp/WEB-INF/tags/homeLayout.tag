                                    ...
                                    <div id="container" class='row'>
                                        ...
                                        <div id='right' class='col-lg-3' style='background-color: #ffffff; border: solid 2px #f4f4f4; border-radius: 6px;'>
                                            <ul class='tabs' style="padding: 2%;margin: 0; display: block;list-style-type: disc;">
                                                <li style="list-style: none; display: inline;"><a style=" padding:2% 4%;display:inline-block;background:#666;color:#fff;text-decoration:none;" href='#tab1'>Friend</a>
                                                </li>
                                                <li style="list-style: none; display: inline;"><a style=" padding:2% 4%;display:inline-block;background:#666;color:#fff;text-decoration:none;" href='#tab2'>Invite</a>
                                                </li>
                                                <li style="list-style: none; display: inline;"><a class="active" style=" padding:2% 4%;display:inline-block;background:#666;color:#fff;text-decoration:none;" href='#tab3'>Request</a>
                                                </li>
                                            </ul>
